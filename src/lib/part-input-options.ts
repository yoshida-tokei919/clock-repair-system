...
export const PART_CATEGORIES: PartCategoryOption[] = [
    ...
    { key: "movement", partType: "part_internal", labelJa: "ムーブメント" },
...
const internalPartNameOptions = makePartNameOptions("part_internal", [
    ...
    ["weekday_driving_wheel", "calendar", "曜送り車", "Day driving wheel"],
    ["weekday_jumper", "calendar", "曜送り爪", "Day jumper"],
    ...
    ["rotor_staff", "automatic_winding", "ローター真", "Rotor staff"],
    ["rotor_staff_screw", "automatic_winding", "ローター真ネジ", "Rotor staff screw"],
    ...
    ["battery", "quartz", "電池", "Battery"],
    ["battery_clamp", "quartz", "電池押さえ", "Battery clamp"],
    ["battery_clamp_screw", "quartz", "電池押さえネジ", "Battery clamp screw"],
    ["contact_spring", "quartz", "接点バネ", "Contact spring"],
    ["insulating_sheet", "quartz", "絶縁板", "Insulating sheet"],
    ["circuit_spacer", "quartz", "回路スペーサー", "Circuit spacer"],
    ["capacitor", "quartz", "キャパシタ", "Capacitor"],
    ["fifth_wheel_quartz", "quartz", "五番車", "Fifth wheel"],
    ["movement", "movement", "ムーブメント", "Movement"],
