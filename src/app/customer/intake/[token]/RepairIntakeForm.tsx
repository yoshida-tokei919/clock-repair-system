...
export function RepairIntakeForm({ token }: { token: string }) {
  ...
  return <PageFrame>
    ...
    <form className="mt-6 space-y-8" onSubmit={submit} noValidate>
      ...
      <ReturnAddressFields sameAsCustomer={returnAddressSameAsCustomer} setSameAsCustomer={setReturnAddressSameAsCustomer} address={returnAddress} setAddress={setReturnAddress} lookupMessage={returnPostalLookupMessage} onLookup={() => void lookupReturnPostalCode()} />
