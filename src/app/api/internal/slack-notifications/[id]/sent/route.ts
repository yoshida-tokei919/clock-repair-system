...
import { markSlackNotificationSent } from "@/lib/slack-notification-outbox";
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  const acknowledged = await markSlackNotificationSent(prisma, { id, claimToken: body.claimToken });
