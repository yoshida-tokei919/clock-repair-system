...
import { cancelLineManagerSenderWork, LineManagerSenderInputError, parseLineManagerSenderId } from "@/lib/line-manager-sender-internal";
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    const ok = await cancelLineManagerSenderWork(prisma, parseLineManagerSenderId(params.id));
