...
import { claimLineManagerReconciliationWork } from "@/lib/line-manager-sender-internal";
...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json({ ok: true, item: await claimLineManagerReconciliationWork(prisma) });
}
